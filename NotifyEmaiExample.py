...
notify.Reboost(mail_host='smtp.163.com', mail_user='xxxx@163.com', # set the smtp Email server info
               mail_pass='xxxx', default_reciving_list=['xxx@163.com'], # set the smtp password and default_reciving_list
               log_root_path='log', max_log_cnt=5)  # set the log path, by default in ./log
